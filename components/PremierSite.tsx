...
const PMR = "https://www.pmrloans.com";
...
export function PremierSite() {
  ...
  return <div className={styles.page}>
    ...
    <header className={styles.header}>
      <a href="#main" aria-label="Premier Mortgage Resources home"><Mark /></a>
      <nav aria-label="Main navigation" className={`${styles.navigation} ${menuOpen ? styles.menuOpen : ""}`} id="main-navigation">
        <a href="#financing" onClick={() => setMenuOpen(false)}>Home loans</a>
        <a href="#journey" onClick={() => setMenuOpen(false)}>The Premier difference</a>
    ...
    <main id="main">
      ...
      <section className={styles.previewGrid} aria-label="Your next move">
        <a href="#financing" className={`${styles.previewCard} ${styles.homeCard}`}>
          <div className={styles.houseVisual}><img src="/hero.jpg" alt="A modern home with warmly lit windows at dusk" width="2400" height="1350" fetchPriority="high" /><span className={styles.photoTag}>ROOM FOR WHAT’S NEXT</span></div>
          <div className={styles.previewLabel}><div><h2>Make yourself at home.</h2><p>First home. Next home. Your home.</p></div><Arrow diagonal /></div>
        </a>
